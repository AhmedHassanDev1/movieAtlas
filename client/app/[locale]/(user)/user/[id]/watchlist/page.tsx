...
function Page() {
  ...
  const {
    ...
    queryFn: ({ pageParam }) => getUserTitleInteraction({ userId: id, type: "watchlist", limit: 5, page: pageParam }),
    initialPageParam: 1,
    enabled: !!id,
  ...
  return (
    <Stack sx={{ width: "100%" }}>
      <Typography variant="h5" sx={{ fontWeight: 500 }}>{stat?.watchlist_count} {t("title.titles")}</Typography>
